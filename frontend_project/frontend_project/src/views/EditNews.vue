...
export default {
  ...
  mounted() {
    this.$axios.get(`http://localhost:8080/projekat_backend_war_exploded/api/news/${this.$route.params.id}`,{headers: {
  ...
  methods: {
    editNews() {
      var x = 0;
      this.$axios.post(`http://localhost:8080/projekat_backend_war_exploded/api/news/update`,{
