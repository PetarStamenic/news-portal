...
export default {
  ...
  mounted() {
    this.$axios.get(`http://localhost:8080/projekat_backend_war_exploded/api/users/${this.$route.params.email}`,{headers: {
  ...
  methods: {
    editOldUser() {
      this.$axios.post(`http://localhost:8080/projekat_backend_war_exploded/api/users/${this.$route.params.email}`, {
